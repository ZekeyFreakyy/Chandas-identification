...
- MacOS (e.g., `.dmg` file)
- Linux (e.g., `.AppImage` or `.deb` file)
...
4. Once installed, find the Chandas-identification icon on your desktop or start menu.
...
- Supports recognition of 10 common Sanskrit meters including Anuṣṭubh, Indravajrā, Mandākrāntā, and Vasantatilakā.
...
## 🧑‍💻 How to Use Chandas-identification

1. Open the installed application.
2. In the main window, find the input box.
3. Type or paste Sanskrit text written in Devanagari script.
4. Click the "Analyze" or "Identify Meter" button.
5. Wait a moment while the machine learning system processes the input.
6. View the results below the input box.
7. Explore the confidence levels and explanations to better understand the output.
